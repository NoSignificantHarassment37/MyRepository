...
void PunterosYMemoria()
{
	...
	en donde est� ese objeto.

	De momento las utilidades parecen pocas pero m�s adelante voy a investigar para que sirven.
	*/
	...
	&a obtiene la direcci�n en memoria de a
	*p le dice que traiga lo que hay en la direcci�n que p guarda.
	*/

	int* p = &a; // No es una copia del valor, p apunta a la direccion en memoria a la que 'a' apunta. Por eso cuando la cambio, parece que p tambi�n cambia.
	...
	// Referencias: son alias para variables, no se para que se usar�an, adem�s de que no se puede cambiar a que variable apuntan.
